...
class UpdateUserData(BaseModel):
    ...
    username: Optional[StrictStr] = Field(default=None, description="The new username to assign to the user, if not provided, the current username will be used.")
    visible_email: Optional[StrictBool] = Field(default=None, description="Determines if the user's email is visible to other users, if not provided, the current value will be used.")
    website: Optional[StrictStr] = Field(default=None, description="The new website to assign to the user, if not provided, the current website will be used. Used for linking to the user's personal or company website.")
    __properties: ClassVar[List[str]] = ["name", "organization_id", "role", "user_id", "username", "visible_email", "website"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if visible_email (nullable) is None
        # and model_fields_set contains the field
        if self.visible_email is None and "visible_email" in self.model_fields_set:
            _dict['visible_email'] = None
