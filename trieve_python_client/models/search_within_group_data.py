...
class SearchWithinGroupData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["date_bias", "filters", "group_id", "group_tracking_id", "highlight_delimiters", "highlight_results", "page", "page_size", "query", "score_threshold", "search_type", "use_weights"]
