...
from trieve_python_client.api_client import ApiClient, RequestSerialized
from trieve_python_client.api_response import ApiResponse
from trieve_python_client.rest import RESTResponseType
...
class ChunkApi:
    ...
    def get_recommended_chunks(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RecommendChunksResponseTypes",
            '400': "ErrorResponseBody",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    def get_recommended_chunks_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RecommendChunksResponseTypes]:
        """Get Recommended Chunks
    ...
    def search_chunk(
        ...
        _param = self._search_chunk_serialize(
            tr_dataset=tr_dataset,
    ...
    @validate_call
    def search_chunk_with_http_info(
        self,
        tr_dataset: Annotated[StrictStr, Field(description="The dataset id to use for the request")],
        search_chunk_data: Annotated[SearchChunkData, Field(description="JSON request payload to semantically search for chunks (chunks)")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SearchChunkResponseTypes]:
        """Search
    ...
    @validate_call
    def search_chunk_without_preload_content(
        self,
        tr_dataset: Annotated[StrictStr, Field(description="The dataset id to use for the request")],
        search_chunk_data: Annotated[SearchChunkData, Field(description="JSON request payload to semantically search for chunks (chunks)")],
        _request_timeout: Union[
