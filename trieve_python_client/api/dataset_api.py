...
class DatasetApi:
    ...
    def delete_dataset(
        self,
        tr_organization: Annotated[StrictStr, Field(description="The organization id to use for the request")],
        delete_dataset_request: Annotated[DeleteDatasetRequest, Field(description="JSON request payload to delete a dataset")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param tr_organization: The organization id to use for the request (required)
        :type tr_organization: str
        :param delete_dataset_request: JSON request payload to delete a dataset (required)
