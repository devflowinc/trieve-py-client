...
class EventsApi:
    ...
    def get_events(
        ...
        get_events_data: Annotated[GetEventsData, Field(description="JSON request payload to get events for a dataset")],
    ...
    def _get_events_serialize(
        ...
        if get_events_data is not None:
            _body_params = get_events_data
