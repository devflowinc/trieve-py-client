...
class UpdateDatasetRequest(BaseModel):
    ...
    dataset_id: StrictStr = Field(description="The id of the dataset you want to update.")
    ...
    __properties: ClassVar[List[str]] = ["client_configuration", "dataset_id", "dataset_name", "server_configuration"]
