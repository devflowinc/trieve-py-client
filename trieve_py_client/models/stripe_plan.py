...
class StripePlan(BaseModel):
    ...
    created_at: datetime
    dataset_count: StrictInt
    file_storage: StrictInt
    id: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["amount", "chunk_count", "created_at", "dataset_count", "file_storage", "id", "message_count", "name", "stripe_id", "updated_at", "user_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "file_storage": obj.get("file_storage"),
            "id": obj.get("id"),
