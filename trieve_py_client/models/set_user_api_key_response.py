...
class SetUserApiKeyResponse(BaseModel):
    """
    SetUserApiKeyResponse
    """ # noqa: E501
    api_key: StrictStr = Field(description="The api key which was created. This is the value which should be used in the Authorization header.")
