...
class SearchOverGroupsSlimResults(BaseModel):
    """
    SearchOverGroupsSlimResults
    """ # noqa: E501
    group_chunks: List[GroupScoreSlimChunks]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "group_chunks": [GroupScoreSlimChunks.from_dict(_item) for _item in obj["group_chunks"]] if obj.get("group_chunks") is not None else None,
