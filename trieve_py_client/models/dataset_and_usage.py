...
class DatasetAndUsage(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dataset", "dataset_usage"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of dataset_usage
        if self.dataset_usage:
            _dict['dataset_usage'] = self.dataset_usage.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dataset": DatasetDTO.from_dict(obj["dataset"]) if obj.get("dataset") is not None else None,
            "dataset_usage": DatasetUsageCount.from_dict(obj["dataset_usage"]) if obj.get("dataset_usage") is not None else None
        })
        return _obj
