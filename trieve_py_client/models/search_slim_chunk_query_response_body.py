...
class SearchSlimChunkQueryResponseBody(BaseModel):
    """
    SearchSlimChunkQueryResponseBody
    """ # noqa: E501
    score_chunks: List[ScoreSlimChunks]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "score_chunks": [ScoreSlimChunks.from_dict(_item) for _item in obj["score_chunks"]] if obj.get("score_chunks") is not None else None,
