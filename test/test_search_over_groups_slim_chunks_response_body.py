...
class TestSearchOverGroupsSlimChunksResponseBody(unittest.TestCase):
    """SearchOverGroupsSlimChunksResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchOverGroupsSlimChunksResponseBody:
        """Test SearchOverGroupsSlimChunksResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchOverGroupsSlimChunksResponseBody`
        """
        model = SearchOverGroupsSlimChunksResponseBody()
        if include_optional:
            return SearchOverGroupsSlimChunksResponseBody(
                group_chunks = [
    ...
    def testSearchOverGroupsSlimChunksResponseBody(self):
        """Test SearchOverGroupsSlimChunksResponseBody"""
