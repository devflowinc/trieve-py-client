...
class TestSearchWithinGroupSlimResults(unittest.TestCase):
    """SearchWithinGroupSlimResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchWithinGroupSlimResults:
        """Test SearchWithinGroupSlimResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchWithinGroupSlimResults`
        """
        model = SearchWithinGroupSlimResults()
        if include_optional:
            return SearchWithinGroupSlimResults(
                bookmarks = [
    ...
    def testSearchWithinGroupSlimResults(self):
        """Test SearchWithinGroupSlimResults"""
