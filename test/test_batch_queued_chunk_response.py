...
class TestBatchQueuedChunkResponse(unittest.TestCase):
    """BatchQueuedChunkResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchQueuedChunkResponse:
        """Test BatchQueuedChunkResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchQueuedChunkResponse`
        """
        model = BatchQueuedChunkResponse()
        if include_optional:
            return BatchQueuedChunkResponse(
                chunk_metadata = [
    ...
    def testBatchQueuedChunkResponse(self):
        """Test BatchQueuedChunkResponse"""
