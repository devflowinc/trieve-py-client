    ...
    def make_instance(self, include_optional) -> UploadFileResult:
        ...
        if include_optional:
            return UploadFileResult(
                file_metadata = {"created_at":"2021-01-01T00:00:00","dataset_id":"e3e3e3e3-e3e3-e3e3-e3e3-e3e3e3e3e3e3","file_name":"file.txt","id":"e3e3e3e3-e3e3-e3e3-e3e3-e3e3e3e3e3e3","link":"https://trieve.ai","metadata":{"key":"value"},"size":1000,"tag_set":"tag1,tag2","time_stamp":"2021-01-01T00:00:00","updated_at":"2021-01-01T00:00:00"}
            )
        else:
            return UploadFileResult(
                file_metadata = {"created_at":"2021-01-01T00:00:00","dataset_id":"e3e3e3e3-e3e3-e3e3-e3e3-e3e3e3e3e3e3","file_name":"file.txt","id":"e3e3e3e3-e3e3-e3e3-e3e3-e3e3e3e3e3e3","link":"https://trieve.ai","metadata":{"key":"value"},"size":1000,"tag_set":"tag1,tag2","time_stamp":"2021-01-01T00:00:00","updated_at":"2021-01-01T00:00:00"},
