...
class TestCreateOrganizationData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateOrganizationData:
        """Test CreateOrganizationData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateOrganizationData`
        """
        model = CreateOrganizationData()
        if include_optional:
    ...
    def testCreateOrganizationData(self):
        """Test CreateOrganizationData"""
