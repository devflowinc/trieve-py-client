...
class TestGroupSlimChunksDTO(unittest.TestCase):
    """GroupSlimChunksDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupSlimChunksDTO:
        """Test GroupSlimChunksDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupSlimChunksDTO`
        """
        model = GroupSlimChunksDTO()
        if include_optional:
            return GroupSlimChunksDTO(
                group_id = '',
                metadata = [
    ...
    def testGroupSlimChunksDTO(self):
        """Test GroupSlimChunksDTO"""
