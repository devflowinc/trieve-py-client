...
class TestSearchGroupSlimChunksResult(unittest.TestCase):
    """SearchGroupSlimChunksResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchGroupSlimChunksResult:
        """Test SearchGroupSlimChunksResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchGroupSlimChunksResult`
        """
        model = SearchGroupSlimChunksResult()
        if include_optional:
            return SearchGroupSlimChunksResult(
                bookmarks = [
    ...
    def testSearchGroupSlimChunksResult(self):
        """Test SearchGroupSlimChunksResult"""
