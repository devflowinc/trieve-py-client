...
class TestSuggestedQueriesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SuggestedQueriesResponse:
        """Test SuggestedQueriesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuggestedQueriesResponse`
        """
        model = SuggestedQueriesResponse()
        if include_optional:
    ...
    def testSuggestedQueriesResponse(self):
        """Test SuggestedQueriesResponse"""
