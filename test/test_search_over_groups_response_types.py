...
class TestSearchOverGroupsResponseTypes(unittest.TestCase):
    """SearchOverGroupsResponseTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchOverGroupsResponseTypes:
        """Test SearchOverGroupsResponseTypes
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchOverGroupsResponseTypes`
        """
        model = SearchOverGroupsResponseTypes()
        if include_optional:
    ...
    def testSearchOverGroupsResponseTypes(self):
        """Test SearchOverGroupsResponseTypes"""
