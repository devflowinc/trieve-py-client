...
class TestSearchWithinGroupResponseTypes(unittest.TestCase):
    """SearchWithinGroupResponseTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchWithinGroupResponseTypes:
        """Test SearchWithinGroupResponseTypes
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchWithinGroupResponseTypes`
        """
        model = SearchWithinGroupResponseTypes()
        if include_optional:
    ...
    def testSearchWithinGroupResponseTypes(self):
        """Test SearchWithinGroupResponseTypes"""
